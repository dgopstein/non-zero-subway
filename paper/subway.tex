...
\begin{table*}[b]
  ...
  \begin{tabular}
      {ll}
      \includegraphics[width=\columnwidth]{layout_view} &
      \includegraphics[width=\columnwidth]{prediction_view} \\
      \includegraphics[width=\columnwidth]{values_view} &
      \includegraphics[width=\columnwidth]{cumulative_view} \\
 \end{tabular}
\end{table*}
